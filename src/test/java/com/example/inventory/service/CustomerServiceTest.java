...
class CustomerServiceTest {
    ...
    void testGetAllCustomers_returnsList() {
        Customer c1 = new Customer("Alice", "alice@example.com", "testPassword1");
        Customer c2 = new Customer("Bob", "bob@example.com", "testPassword2");
    ...
    void testGetCustomerById_found() {
        Customer c = new Customer("Test", "test@example.com", "testPassword3");
    ...
    void testSaveCustomer_savesAndReturnsEntity() {
        Customer c = new Customer("New Cust", "newcust@example.com", "testPassword4");
        ...
        assertEquals("newcust@example.com", saved.getEmail());
